 ...
 *
 */
define(['dojo/_base/declare', 'sdk/modules/npe/Track', 'sdk/modules/npe/Artist', 'sdk/modules/npe/Album'], function (declare, Track, Artist, Album) {
  var song = declare([], {
    ...
    track: function () {
      ...
      if (this.trackInstance == null) this.trackInstance = new Track(this.songData.track, this.platformId);
    ...
    artist: function () {
      ...
      if (this.artistInstance == null) this.artistInstance = new Artist(this.songData.artists[0], this.platformId);
    ...
    album: function () {
      ...
      if (this.albumInstance == null) this.albumInstance = new Album(this.songData.album, this.platformId);
