...
define([
...
], function ( declare, lang, adModule, AdServerType ) {
    ...
    var mediaAdModule = declare([ adModule ], {
        ...
        init:function( adConfig )
        {
            ...
            if( adConfig.mediaUrl != undefined )
                this.playAdUrl( adConfig );
            else
        ...
        playAdUrl:function( adConfig )
        {
            ...
            if( isWebUrl == true )
            {
                ...
                this.emit( this.AD_MODULE_MEDIA_READY, { adServerType: AdServerType.MEDIA_AD,
