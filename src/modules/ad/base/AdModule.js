...
define([
  ...
  "dojo/on",
  "dojo/_base/lang",
  "sdk/base/ad/AdQuartile",
  "sdk/base/ad/AdModuleEvents",
], function (declare, on, lang, adQuartile, adModuleEvents) {
  var adModule = declare([adModuleEvents], {
    ...
    init: function () {
      ...
      this.onAdPlaybackStatusListener = this.target.on(
        "ad-playback-status",
        lang.hitch(this, this._onAdPlaybackStatus)
      );
    ...
    initAdListeners: function (html5OnDemand) {
      ...
      this.clickTrackingElementClickedHandler =
        this.html5OnDemand.setClickTrackingElementClickedHandler(
          lang.hitch(this, this._onClickTrackingElementClicked)
        );
      this.adPlaybackCompleteHandler = this.target.on(
        "ad-playback-complete",
        lang.hitch(this, this._destroyAdlisteners)
      );
      this.adPlaybackDestroyHandler = this.target.on(
        "ad-playback-destroy",
        lang.hitch(this, this._destroyAdlisteners)
      );
      this.adPlaybackErrorHandler = this.target.on(
        "ad-playback-error",
        lang.hitch(this, this._destroyAdlisteners)
      );
    },
    ...
    _onAdPlaybackStatus: function (e) {
      ...
      if (e.code == "MEDIA_STARTED") {
        ...
        this._checkVideoPlaybackQuartile(
          this._getTimePercent(currentTime, duration)
        );
