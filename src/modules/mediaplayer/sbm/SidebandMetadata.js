...
define(['dojo/_base/declare', 'dojo/on', 'dojo/_base/lang', 'sdk/modules/mediaplayer/sbm/SidebandMetadataConnector'], function (declare, on, lang, SidebandMetadataConnector) {
  var sidebandMetadata = declare([], {
    ...
    init: function (params) {
      ...
      this.sidebandMetadataConnector.setSidebandMetadataFallbackCallback(lang.hitch(this, this.__onSidebandMetadataFallback));
      this.sidebandMetadataConnector.connect(this.__getMetadataConnectionUrl(params.url, params.mount, params.sbmConfig));
    },
    ...
    getStreamConnectionUrl: function (url) {
      return url + (url.indexOf('?') != -1 ? '&' : '?') + 'sbmid=' + this.__generateSessionId();
    },
    ...
    __getMetadataConnectionUrl: function (url, mount, sbmConfig) {
      if (url && mount && sbmConfig !== null && sbmConfig.info !== null) {
        return url.split('/')[0] + '//' + url.split('/')[2] + '/' + mount + sbmConfig.info.metadataSuffix + '?sbmid=' + this._sessionId;
      }
      return null;
    },
    ...
    __generateSessionId: function () {
      ...
      this._sessionId = 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function (c) {
