...
define([
  ...
  var module = declare([techModule], {
    ...
    start: function () {
      ...
      this.html5Live.setPlaybackStatusHandler(
        lang.hitch(this, this._onPlaybackStatus)
      );
      this.html5Live.setCuePointHandler(
        lang.hitch(this, this._onTrackCuePoint)
      );
      this.html5Live.setAdBreakHandler(lang.hitch(this, this._onAdBreak));
      this.html5Live.setHlsCuePointHandler(
        lang.hitch(this, this._onHlsCuePoint)
      );
      this.html5Live.setSpeechCuePointHandler(
        lang.hitch(this, this._onSpeechCuePoint)
      );
      this.html5Live.setCustomCuePointHandler(
        lang.hitch(this, this._onCustomCuePoint)
      );
      this.html5Live.setStreamStartHandler(
        lang.hitch(this, this._onStreamStart)
      );
      this.html5Live.setStreamStopHandler(lang.hitch(this, this._onStreamStop));
      this.html5Live.setStreamFailedHandler(
        lang.hitch(this, this._onStreamFailed)
      );
      this.html5Live.setTimeshiftInfoHandler(
        lang.hitch(this, this._onTimeshiftInfo)
      );
    ...
    playStream: function (params) {
      ...
      if (!this._isMediaTagInitialized) this._initMediaTag();
    ...
    seekFromLive: function (seconds) {
      this.inherited(arguments);
      this.html5Live.seekFromLive(seconds);
    },

    getCloudStreamInfo: function () {
      this.inherited(arguments);
      this.html5Live.getCloudStreamInfo();
    },

    playProgram: function (programID, offset) {
      this.inherited(arguments);
    ...
    playMedia: function (params) {
      ...
      if (params.url.indexOf("live.streamtheworld.com") >= 0) {
        ...
        this.playbackOnDemandStatushandler =
          this.html5OnDemand.setPlaybackStatusHandler(
            lang.hitch(this, this._onMediaPlaybackStatus)
          );
    ...
    _onAdBreak: function (data) {
      ...
      if (data.cuePoint != undefined) {
        data.adBreakData = {};
        data.adBreakData.adVast =
          data.cuePoint[BreakCuePoint.AD_VAST] != undefined &&
          data.cuePoint[BreakCuePoint.AD_VAST] != ""
            ? data.cuePoint[BreakCuePoint.AD_VAST]
            : null;
        data.adBreakData.cueID =
          data.cuePoint[BreakCuePoint.AD_ID] != undefined &&
          data.cuePoint[BreakCuePoint.AD_ID] != ""
            ? data.cuePoint[BreakCuePoint.AD_ID]
            : null;
        data.adBreakData.cueTitle =
          data.cuePoint[BreakCuePoint.CUE_TITLE] != undefined &&
          data.cuePoint[BreakCuePoint.CUE_TITLE] != ""
            ? data.cuePoint[BreakCuePoint.CUE_TITLE]
            : null;
        data.adBreakData.duration =
          data.cuePoint[BreakCuePoint.CUE_TIME_DURATION] != undefined &&
          data.cuePoint[BreakCuePoint.CUE_TIME_DURATION] != ""
            ? data.cuePoint[BreakCuePoint.CUE_TIME_DURATION]
            : null;
        data.adBreakData.isVastInStream =
          (data.cuePoint[BreakCuePoint.AD_VAST_URL] != undefined &&
            data.cuePoint[BreakCuePoint.AD_VAST_URL] != "") ||
          (data.cuePoint[BreakCuePoint.AD_VAST] &&
            data.cuePoint[BreakCuePoint.AD_VAST] != "")
            ? true
            : false;
        data.adBreakData.url =
          data.cuePoint[BreakCuePoint.AD_URL] != undefined &&
          data.cuePoint[BreakCuePoint.AD_URL] != ""
            ? data.cuePoint[BreakCuePoint.AD_URL]
            : null;
        data.adBreakData.vastUrl =
          data.cuePoint[BreakCuePoint.AD_VAST_URL] != undefined &&
          data.cuePoint[BreakCuePoint.AD_VAST_URL] != ""
            ? data.cuePoint[BreakCuePoint.AD_VAST_URL]
            : null;
      ...
      if (
        data.adBreakData.isVastInStream == true &&
        (data.adBreakData.adVast || data.adBreakData.vastUrl)
      ) {
    ...
    _onMediaPlaybackStatus: function (e) {
      ...
      if (e.type == "Error") {
        ...
        this.emit("media-playback-timeupdate", {
          ...
          remainingTime: parseInt(
            e.html5Node.duration - e.html5Node.currentTime
          ),
      ...
      if (e.type == "Ended") this.html5OnDemand.stop();
    },
    ...
    _isHTML5Supported: function () {
      this.html5CheckerNode = domConstruct.create(
        "audio",
        {
          id: "testHtml5Node",
        },
