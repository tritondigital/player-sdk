...
function Metrics(data) {
  ...
  function parse(context, data) {
    context.wcmStationId = data["listener-tracking"]
      ? data["listener-tracking"]._attr["wcm-station-id"]._value
      : 0;
    context.listenerTrackingURL = data["listener-tracking"]
      ? data["listener-tracking"]._attr["url"]._value
      : "";
