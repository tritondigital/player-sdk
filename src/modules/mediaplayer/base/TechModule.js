...
define([
  ...
  var module = declare([coreModule], {
    ...
    restartConnectionTimeOut: function () {
      ...
      if (this.connectionTimeOutTimer) clearInterval(this.connectionTimeOutTimer);

      if (this._currentLiveApiParams.connectionTimeOut > 0) this.connectionTimeOutTimer = setInterval(lang.hitch(this, this.__onTimeOutAlert), this._currentLiveApiParams.connectionTimeOut * 60000);
    },
    ...
    __extractOmnyParameters: function (params) {
      ...
      if ((params.omnyOrganizationId == undefined || params.omnyClipId == undefined) && params.enableOmnyAnalytics && params.file.indexOf('omny.fm') > -1) {
    ...
    _sanitiseDistParam: function (streamUrl, params) {
      let isTimeshift = streamUrl.indexOf('/HLSRW/') > -1 || streamUrl.indexOf('/CLOUD/') > -1;
