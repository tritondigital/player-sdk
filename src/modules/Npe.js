...
define([
    ...
    var npe = declare([ coreModule ], {
        ...
        {
            if ( isDynamicCall )
                npUrl = this._getDynamicSongUrl( artist, title );

            var xhrProv = new XhrProvider();
            xhrProv.request( npUrl, { npeId: npeId, npUrl:npUrl, isDynamicCall:isDynamicCall, artist:artist, title:title, deferred:deferred }, this._getRequestArgs(), lang.hitch( this, this._onLoadComplete ), lang.hitch( this, this._onLoadError ) );
