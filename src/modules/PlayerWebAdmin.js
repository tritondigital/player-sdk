...
define([
    ...
    var module = declare([ coreModule ], {
        ...
        load:function( mount, streamid )
        {
            ...
            xhrProv.request( this.platform.endpoint.playerWebAdmin, requestArgs.query, { handleAs: "xml", preventCache: true, query:requestArgs.query, headers: { 'X-Requested-With': null, 'Content-Type': 'text/plain; charset=utf-8' } },
            function( query, data ) {
