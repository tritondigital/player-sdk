...
define([
...
], function (declare, lang, array, dom, on, domConstruct, coreModule, Companions) {
    ...
    var module = declare([ coreModule ], {
        ...
        getSyncedElementBySize:function(width, height)
        {
            ...
            array.forEach(this.config.elements, function(item) {
        ...
        _onAdBreakCuePointComplete:function(e)
        {
            ...
            if ( !this.config.keepElementsVisible )
                this._hideElements();
        },
        ...
        _showVastCompanions:function(e)
        {
            ...
            {
                array.forEach(vastCompanions, function(item, index) {
        ...
        _cleanAdVastListeners:function()
        {
            ...
            if ( this.vastErrorListener )
                this.vastErrorListener.remove();
        },
        ...
        _filterCompanionAds:function( companionAds )
        {
            ...
            array.forEach( this._vastCompanionPriority, function(item){

                array.forEach(companionAds, function(companionAd){
