define(['doh/main', '../json', '../has'], function (doh, JSON, has) {
  ...
  doh.register('tests.json', [
    ...
    function simpleFalse(t) {
      t.is(false, JSON.parse('{"foo":false}').foo);
    },
    function simpleNull(t) {
      t.is(null, JSON.parse('{"foo":null}').foo);
    },
    function simpleNumber(t) {
    ...
    function strictTrue(t) {
      t.is(true, JSON.parse('{"foo":true}', true).foo);
    },
    function strictFalse(t) {
      t.is(false, JSON.parse('{"foo":false}', true).foo);
    },
    function strictNull(t) {
      t.is(null, JSON.parse('{"foo":null}', true).foo);
    },
    function strictNumber(t) {
      t.is(3.3, JSON.parse('{"foo":3.3}', true).foo);
    },
    function strictNumberNeg(t) {
      t.is(-3.3, JSON.parse('{"foo":-3.3}', true).foo);
    },
    function exponentNegative(t) {
      t.is(3.3e-33, JSON.parse('{"foo":3.3e-33}', true).foo);
    },
    function exponent(t) {
      t.is(3.3e33, JSON.parse('{"foo":3.3e33}', true).foo);
    },
    function array(t) {
      t.is(3, JSON.parse('{"foo":[3,true,[]]}', true).foo[0]);
    },
    function badCall(t) {
      mustThrow('{"foo":alert()}');
    },
    ...
    function serializeInfinity(t) {
      t.is('{"foo":null}', JSON.stringify({ foo: Infinity }));
    },
