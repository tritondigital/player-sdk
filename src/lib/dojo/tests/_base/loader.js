define([
  ...
  if (doh.isBrowser) {
    doh.register(
      ...
      require.toUrl("./loader/asyncWithDojoRequire.html")
    );

    doh.register(
      "tests._base.loader.config?dojoConfig-djConfig-require",
      require.toUrl("./loader/config.html") + "?dojoConfig-djConfig-require"
    );
    doh.register(
      "tests._base.loader.config?dojoConfig-require",
      require.toUrl("./loader/config.html") + "?dojoConfig-require"
    );
    doh.register(
      "tests._base.loader.config?dojoConfig-djConfig",
      require.toUrl("./loader/config.html") + "?dojoConfig-djConfig"
    );
    doh.register(
      "tests._base.loader.config?dojoConfig",
      require.toUrl("./loader/config.html") + "?dojoConfig"
    );
    doh.register(
      "tests._base.loader.config?djConfig-require",
      require.toUrl("./loader/config.html") + "?djConfig-require"
    );
    doh.register(
      "tests._base.loader.config?djConfig",
      require.toUrl("./loader/config.html") + "?djConfig"
    );
    doh.register(
      "tests._base.loader.config?require",
      require.toUrl("./loader/config.html") + "?require"
    );
    if (has("dojo-publish-privates")) {
      doh.register(
        "tests._base.loader.config?configApi.html",
        require.toUrl("./loader/configApi.html")
      );
    }
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/config-sniff-djConfig.html")
    );
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/declareStepsOnProvide.html")
    );

    doh.register(
      "tests._base.loader.publish-require-result",
      require.toUrl("./loader/publishRequireResult.html")
    );
    doh.register(
      "tests._base.loader.no-publish-require-result",
      require.toUrl("./loader/publishRequireResult.html") + "?do-not-publish"
    );

    doh.register(
      "tests._base.loader.top-level-module-by-paths",
      require.toUrl("./loader/paths.html")
    );
    doh.register(
      "tests._base.loader.xdomin-sync-1",
      require.toUrl("./loader/xdomain/xdomain.html"),
      { async: 0, variation: 1 }
    );
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/xdomain/xdomain.html"),
      { async: "legacyAsync", variation: 1 }
    );
    doh.register(
      "tests._base.loader.xdomin-async-2",
      require.toUrl("./loader/xdomain/xdomain.html"),
      { async: "legacyAsync", variation: 2 }
    );
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/simple.html"),
      { async: 0 }
    );
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/config.html"),
      { async: 0 }
    );
    doh.register(
    ...
    if (has("dojo-requirejs-api")) {
      doh.register(
        "tests._base.loader.requirejs-dataMain-sync",
        require.toUrl("./loader/requirejs/dataMain.html"),
        { async: 0 }
      );
      doh.register(
        "tests._base.loader.requirejs-dataMain-async",
        require.toUrl("./loader/requirejs/dataMain.html"),
        { async: 1 }
      );
    }
    doh.register(
      ...
      require.toUrl("./loader/requirejs/simple-nohead.html"),
      { async: 0 }
    );
    doh.register(
    ...
    var qstart = location.href.indexOf(location.search),
      root = qstart != -1 ? location.href.substring(0, qstart) : location.href,
      setup = compactPath(
        root + "/../" + require.toUrl("./loader/requirejs/requirejs-setup.js")
      ),
      baseUrl = setup.substring(0, setup.length - "/requirejs-setup.js".length);
    if (has("ie") > 6) {
      doh.register(
        "tests._base.loader.requirejs-simple-badbase-sync",
        require.toUrl("./loader/requirejs/simple-badbase.html"),
        {
          async: 0,
          baseUrl: baseUrl,
          setup: setup,
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/circular.html"),
      { async: 1 }
    );

    if (has("dojo-requirejs-api")) {
      doh.register(
        "tests._base.loader.requirejs-depoverlap-sync",
        require.toUrl("./loader/requirejs/depoverlap.html"),
        { async: 0 }
      );
      doh.register(
        "tests._base.loader.requirejs-depoverlap-async",
        require.toUrl("./loader/requirejs/depoverlap.html"),
        { async: 1 }
      );
    }
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/urlfetch/urlfetch.html"),
      { async: 0 }
    );
    doh.register(
    ...
    if (has("dojo-amd-factory-scan")) {
      doh.register(
        ...
        require.toUrl("./loader/requirejs/uniques/uniques.html"),
        { async: 0 }
      );
      doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/i18n/i18n.html") +
        "?bundle=i18n!nls/fr-fr/colors",
      { async: 0 }
    );
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/i18n/i18n.html") +
        "?bundle=i18n!nls/en-us-surfer/colors",
      { async: 0 }
    );
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/i18n/common.html"),
      { async: 0 }
    );
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/paths/paths.html"),
      { async: 0 }
    );
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/relative/relative.html"),
      { async: 0 }
    );
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/text/text.html"),
      { async: 0 }
    );
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/text/textOnly.html"),
      { async: 0 }
    );
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/requirejs/exports/exports.html"),
      { async: 0 }
    );
    doh.register(
    ...
    doh.register(
      ...
      require.toUrl("./loader/config/test.html"),
      { async: 1 }
    );
  }
});
