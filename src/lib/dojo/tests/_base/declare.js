...
define(['doh/main', 'dojo/aspect', 'dojo/_base/declare', 'dojo/_base/kernel', 'dojo/_base/lang'], function (doh, aspect, declare, kernel, lang) {
  doh.register('tests._base.declare', [
    ...
    function mutatedMethods(t) {
      ...
      aspect.after(tests._base.declare.tmp19.prototype, 'foo', function () {
        a = 1;
      });
      x.foo();
      t.is(2, x.flag);
    ...
    function modifiedInstance(t) {
      ...
      declare('tests._base.declare.tmp23', [tests._base.declare.tmp20, tests._base.declare.tmp21], {
        foo: function () {
          this.inherited(arguments);
          stack.push(22);
        }
