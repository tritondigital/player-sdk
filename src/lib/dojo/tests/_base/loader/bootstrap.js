define(["dojo", "doh", "../../../_base/sniff", "require"], function (
  dojo,
  doh,
  has,
  require
  ...
  doh.register("tests._base._loader.bootstrap", [
    ...
    function getText(t) {
      if (require.getText) {
        var text = require
          .getText(require.toUrl("dojo/tests/_base/loader/getText.txt"))
          .replace(/\r|\n/g, "");
        t.assertEqual("dojo._getText() test data", text);
        if (dojo._getText) {
          text = dojo
            ._getText(require.toUrl("dojo/tests/_base/loader/getText.txt"))
            .replace(/\r|\n/g, "");
          t.assertEqual("dojo._getText() test data", text);
        }
      }
...

    {
      ...
      runTest: function (t) {
        ...
        t.assertTrue(
          typeof dojo.getObject("something.thatisNew", true) == "object"
        );
        ...
        t.assertTrue(
          typeof dojo.getObject("something.thatisNew", true, this) == "object"
        );
      },
      tearDown: function () {
