define(["doh", "dojo", "dojo/_base/url"], function (doh, dojo) {
  ...
  doh.register("dojo.tests._base._loader.modulesIds", [
    ...
    function testModuleIds(t) {
      ...
      check(
        get("./myModule/mySubmodule", refmod),
        "pack1",
      ...
      check(
        get("../util/myModule", refmod),
        "pack1",
        "util/myModule",
        pack1Root + "util/myModule"
      );
    },
    ...
    function moduleUrl(t) {
      ...
      t.is(
        expected.substring(0, expected.length - 11),
        dojo.moduleUrl("dojo.tests")
      );
    ...
    function modulePaths(t) {
      ...
      t.assertEqual(
        compactPath(require.baseUrl + "../some/path/mycoolpath/util/"),
        dojo.moduleUrl("mycoolmod.util")
      );
      t.assertEqual(
        "http://some.domain.com/another/path/mycoolpath/widget/",
      ...
      t.assertEqual(
        ...
        dojo.moduleUrl("mycoolmod.widget.thingy")
      );
    },
    ...
    function moduleUrls(t) {
      ...
      dojo.registerModulePath(
        "ipv4.widget",
        "http://ipv4user:ipv4passwd@some.domain.com:2357/another/path/ipv4/widget"
      );
      dojo.registerModulePath(
        "ipv6.widget",
        "ftp://ipv6user:ipv6passwd@[::2001:0db8:3c4d:0015:0:0:abcd:ef12]:1113/another/path/ipv6/widget"
      );
      dojo.registerModulePath(
        "ipv6.widget2",
        "https://[0:0:0:0:0:1]/another/path/ipv6/widget2"
      );
      ...
      t.assertEqual(
        ...
        new dojo._Url(dojo.moduleUrl("ipv4.widget", "components.html"))
          .authority
      );
      t.assertEqual(
        "ipv4user",
      ...
      t.assertEqual(
        ...
        new dojo._Url(dojo.moduleUrl("ipv4.widget", "components.html?query"))
          .path
      );
      t.assertEqual(
        "q=somequery",
        new dojo._Url(
          dojo.moduleUrl("ipv4.widget", "components.html?q=somequery")
        ).query
      );
      t.assertEqual(
        "fragment",
        new dojo._Url(dojo.moduleUrl("ipv4.widget", "components.html#fragment"))
          .fragment
      );
      ...
      t.assertEqual(
        ...
        new dojo._Url(dojo.moduleUrl("ipv6.widget", "components.html"))
          .authority
      );
      t.assertEqual(
        "ipv6user",
      ...
      t.assertEqual(
        ...
        new dojo._Url(dojo.moduleUrl("ipv6.widget", "components.html?query"))
          .path
      );
      t.assertEqual(
        "somequery",
        new dojo._Url(
          dojo.moduleUrl("ipv6.widget", "components.html?somequery")
        ).query
      );
      t.assertEqual(
        "somefragment",
        new dojo._Url(
          dojo.moduleUrl(
            "ipv6.widget",
            "components.html?somequery#somefragment"
          )
        ).fragment
      );
      ...
      t.assertEqual(
        "[0:0:0:0:0:1]",
        new dojo._Url(dojo.moduleUrl("ipv6.widget2", "components.html"))
          .authority
      );
      t.assertEqual(
        null,
