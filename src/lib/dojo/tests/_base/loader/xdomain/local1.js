...
dojo.loadInit(function () {
  ...
  var dependentModule = dojo.getObject(
    "dojo.tests._base.loader.xdomain.local1-runtimeDependent",
    true
  );
...
dojo.requireIf(
  dojo.getObject("dojo.tests._base.loader.xdomain.local1-runtimeDependent")
    .choice == 1,
  "dojo.tests._base.loader.xdomain.local1-runtimeDependent1"
);
xdomainExecSequence.push("local1-7");
dojo.requireIf(
  dojo.getObject("dojo.tests._base.loader.xdomain.local1-runtimeDependent")
    .choice == 2,
  "dojo.tests._base.loader.xdomain.local1-runtimeDependent2"
);
...
xdomainLog.push(
  1,
  x1 === dojo.tests._base.loader.xdomain.local1,
  2,
  x1 === dojo.getObject("dojo.tests._base.loader.xdomain.local1"),
  3,
  x2 === dojo.tests._base.loader.xdomain.local1SteppedOn,
  4,
  x2 === dojo.getObject("dojo.tests._base.loader.xdomain.local1SteppedOn"),
  5,
  x3 === dojo.tests._base.loader.xdomain.local1NotSteppedOn,
  6,
  x3 === dojo.getObject("dojo.tests._base.loader.xdomain.local1NotSteppedOn")
);
...
xdomainLog.push(
  7,
  "stepOnLocal1" === dojo.tests._base.loader.xdomain.local1,
  8,
  "stepOnLocal1" === dojo.getObject("dojo.tests._base.loader.xdomain.local1"),
  9,
  "stepOn1SteppedOn" === dojo.tests._base.loader.xdomain.local1SteppedOn,
  10,
  "stepOn1SteppedOn" ===
    dojo.getObject("dojo.tests._base.loader.xdomain.local1SteppedOn")
);
