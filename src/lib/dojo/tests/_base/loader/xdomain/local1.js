...
dojo.platformRequire({
  browser: ['dojo.tests._base.loader.xdomain.local1-browser', ['dojo.tests._base.loader.xdomain.local1-browser-skip', true]]
});
...
xdomainLog.push(
  ...
  10,
  'stepOn1SteppedOn' === dojo.getObject('dojo.tests._base.loader.xdomain.local1SteppedOn')
);
