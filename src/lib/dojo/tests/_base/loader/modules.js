define([
  ...
  doh.register("dojo.tests._base._loader.modules", [
    function testAMD(t) {
      ...
      t.is(wrapped.five, 5);
      t.is(
        dojo.require("dojo.tests._base.loader.modules.wrapped"),
      ...
      t.is(
        ...
        "dojo/tests/_base/loader/modules/factoryArity"
      );
      ...
      t.is(
        ...
        "dojo/tests/_base/loader/modules/factoryArityExports"
      );
      ...
      t.is(
        require("./modules/idFactoryArity").module.id,
        "dojo/tests/_base/loader/modules/idFactoryArity"
      );
      t.is(require("./modules/idFactoryArity").id, "idFactoryArity");
      t.is(require("./modules/idFactoryArity").impliedDep, "impliedDep3");

      t.is(
        require("./modules/idFactoryArityExports").module.id,
        "dojo/tests/_base/loader/modules/idFactoryArityExports"
      );
      t.is(
        require("./modules/idFactoryArityExports").id,
        "idFactoryArityExports"
      );
      t.is(
        require("./modules/idFactoryArityExports").impliedDep,
        "impliedDep4"
      );
    },
  ]);
