define(["doh/main", "../has", "../i18n", "require"], function (
  doh,
  has,
  i18n,
  require
) {
  var getAsyncTest = function (value, locale) {
      return function () {
        var def = new doh.Deferred();
        require([
          i18n.getL10nName("dojo/tests", "salutations", locale),
        ], function (bundle) {
    ...
    getSyncTest = function (value, locale) {
      return function () {
        doh.assertEqual(
          value,
          i18n.getLocalization("dojo/tests", "salutations", locale).hello
        );
      };
    },
  ...
  if (has("host-browser")) {
    doh.register("tests.i18n.extra.sync", require.toUrl("./i18n.html"), {
      async: 0,
    });
    doh.register("tests.i18n.extra.async", require.toUrl("./i18n.html"), {
      async: 1,
    });
  }
});
