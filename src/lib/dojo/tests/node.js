define(["doh/main"], function (doh) {
  doh.register("tests.node", [
    ...
    function testRequireSimpleModule(t) {
      var td = new doh.Deferred();
      require(["dojo/node!./tests/resources/nodemodule"], td.getTestCallback(
        function (nodemodule) {
    ...
    function testRequireRequire(t) {
      var td = new doh.Deferred();
      require(["dojo/node!./tests/resources/noderequire"], td.getTestCallback(
    ...
    function testRequirePackageJson(t) {
      var td = new doh.Deferred();
      require(["dojo/node!./tests/resources/nodemod"], td.getTestCallback(
        function (nodemod) {
    ...
    function testRequireCommonJSAMD(t) {
      var td = new doh.Deferred();
      require([
        "dojo/node!./tests/resources/noderequireamd",
      ], td.getTestCallback(function (noderequireamd) {
