define(['doh/main', 'dojo/Deferred', 'dojo/promise/all'], function (doh, Deferred, all) {
  var tests = {
    'all() with array argument': function (t) {
      var obj1 = {},
        ...
        obj3 = {};
      var received;
      all([this.deferred, new Deferred().resolve(obj2), obj3]).then(function (result) {
        received = result;
      });
    ...
    'all() with object argument': function (t) {
      var obj1 = {},
        ...
        obj3 = {};
      var received;
      all({ a: this.deferred, b: new Deferred().resolve(obj2), c: obj3 }).then(function (result) {
        received = result;
      });
      this.deferred.resolve(obj1);
      t.t(received.a === obj1);
    ...
    'all() with one rejected promise': function (t) {
      var obj = {};
      var received;
      all([this.deferred, new Deferred().reject(obj), {}]).then(null, function (result) {
        received = result;
      });
      t.t(received === obj);
    },
    ...
    'all() with one promise rejected later': function (t) {
      var obj = {};
      var received;
      all([this.deferred, new Deferred(), new Deferred()]).then(null, function (result) {
        received = result;
      });
    ...
    'all() with multiple promises rejected later': function (t) {
      ...
      var received;
      all([this.deferred, deferred2, new Deferred()]).then(null, function (result) {
        received = result;
      });
      this.deferred.reject(obj);
      deferred2.reject({});
    ...
    "all() cancel only affects returned promise, not those we're waiting for": function (t) {
      ...
      var received;
      var promise = all([this.deferred, deferred2, new Deferred()]).then(null, function (result) {
        received = result;
      });
      promise.cancel(obj);
      t.t(received === obj);
