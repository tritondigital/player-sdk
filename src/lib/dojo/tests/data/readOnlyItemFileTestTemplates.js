    ...
    },
    {
      ...
      runTest: function (datastore, t) {
        ...
        function completed(items, request) {
          ...
          var orderedArray = ['', '123abc', 'abc', 'abcd', 'abcdefg', 'bca', 'foghorn', 'lmnop', 'qberty', 'qwerty', 'seaweed'];
          t.assertEqual(items.length, 11);
          var passed = true;
          for (var i = 0; i < items.length; i++) {
            var value = store.getValue(items[i], 'value');
    ...
    },
    {
      ...
      runTest: function (datastore, t) {
        ...
        function completed(items, request) {
          ...
          var orderedArray1 = ['BaB{aMa|SaRa***F}oo', 'ba|r*foo', 'bit$Bite', 'boomBam', 'fo|o*b.ar', 'jfq4@#!$!@|f1.$4r14i5u', 'ouagadogou', 'seaweed', 'seaweed', 'seaweed', 'squawl', 'zulu'];
          var passed = true;
          for (var i = 0; i < items.length; i++) {
            var value = store.getValue(items[i], 'value');
