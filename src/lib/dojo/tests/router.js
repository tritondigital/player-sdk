define(["../_base/array", "../hash", "../router/RouterBase", "doh"], function (
  arrayUtil,
  hash,
  RouterBase,
  doh
  ...
  doh.register("tests.router", [
    ...
    },
    {
      ...
      runTest: function (t) {
        ...
        t.t(
          newPath === "/checkEventObject/bar",
          "newPath should be '/checkEventObject/bar', was " + newPath
        );
        t.t(params, "params should be a truthy value, was " + params);
        t.t(params.hasOwnProperty("foo"), "params should have a .foo property");
        t.t(
          params.foo === "bar",
          "params.foo should be bar, was " + params.foo
        );
        t.t(
          stopImmediatePropagation === "function",
          "stopImmediatePropagation should be a function, was " +
            stopImmediatePropagation
        );
        t.t(
          preventDefault === "function",
          "preventDefault should be a function, was " + preventDefault
        );
      },
      tearDown: function () {
        handle.remove();
    ...
    },
    {
      ...
      runTest: function (t) {
        ...
        handle = router.register(
          "/stringtest/:applied/:arg",
          function (event, applied, arg) {
            a = applied;
            b = arg;
          }
        );
    ...
    },
    {
      ...
      runTest: function (t) {
        ...
        t.t(
          ...
          "testObject should have been an object, but wasn't"
        );
        t.t(
          testObject.to === "to",
          "testObject.to should have been 'to', was " + testObject.to
        );
        t.t(
          testObject.some === "some",
          "testObject.some should have been 'some', was " + testObject.some
        );
        t.t(
          testObject["long"] === "long",
          "testObject.long should have been 'long', was " + testObject["long"]
        );
        t.t(
          testObject.thing === "thing/this/is/in/splat",
          "testObject.thing should have been 'thing/this/is/in/splat', was " +
            testObject.thing
        );
        ...
        t.t(
          testObject.to === "1",
          "testObject.to should have been '1', was " + testObject.to
        );
        t.t(
          testObject.some === "2",
          "testObject.some should have been '2', was " + testObject.some
        );
        t.t(
          testObject["long"] === "3",
          "testObject.long should have been '3', was " + testObject["long"]
        );
        t.t(
          testObject.thing === "4/5/6",
          "testObject.thing should have been '4/5/6', was " + testObject.thing
        );
      },
      tearDown: function () {
        handle.remove();
    ...
    },
    {
      ...
      runTest: function (t) {
        ...
        t.t(
          ...
          "testObject should have been an array, but wasn't"
        );
        t.t(
          testObject[0] === "abcdef",
          "testObject[0] should have been 'abcdef', was " + testObject[0]
        );
        t.t(
          testObject[1] === "1234",
          "testObject[1] should have been '1234', was " + testObject[1]
        );
        ...
        t.t(
          testObject === null,
          "testObject should have been null, but wasn't"
        );
        ...
        t.t(
          testObject[0] === "abc123",
          "testObject[0] should have been 'abc123', was " + testObject[0]
        );
        t.t(
          testObject[1] === "456",
          "testObject[1] should have been '456', was " + testObject[1]
        );
      },
      tearDown: function () {
        handle.remove();
    ...
    },
    {
      ...
      runTest: function (t) {
        ...
        handle.push(
          router.register("/stopImmediatePropagation", function () {
            test += "A";
          })
        );
        handle.push(
        ...
        handle.push(
          router.register("/stopImmediatePropagation", function (event) {
    ...
    },
    {
      ...
      runTest: function (t) {
        ...
        handle.push(
          router.register("/preventDefault", function (event) {
        ...
        handle.push(
          router.register("/allowDefault", function (event) {
