define(['doh', 'dojo/store/DataStore', 'dojo/data/ItemFileReadStore', 'dojo/data/ItemFileWriteStore'], function (doh, DataStore, ItemFileReadStore, ItemFileWriteStore) {
  ...
  doh.register('dojo.tests.store.DataStore', [
    ...
    function testQuery1(t) {
      ...
      store.query({ prime: true }).then(
        d.getTestCallback(function (results) {
    ...
    function testQuery2(t) {
      ...
      result.map(
        d.getTestErrback(function (object) {
          for (var i in object) {
