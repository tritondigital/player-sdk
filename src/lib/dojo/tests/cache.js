  ...
  doh.register("tests.cache", [
    {
      ...
      runTest: function (t) {
        ...
        t.is(
          expected,
          dojo.trim(dojo.cache("dojo.tests.cache", "regular.html"))
        );
        t.is(
          expected,
          dojo.trim(
            dojo.cache("dojo.tests.cache", "sanitized.html", { sanitize: true })
          )
        );
        ...
        t.is(
          expected,
          dojo.trim(dojo.cache(new dojo._Url(objPath), { sanitize: true }))
        );
