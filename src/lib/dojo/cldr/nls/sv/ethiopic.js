define(//begin v1.x content
{
  ...
  'months-standAlone-wide': ['Mäskäräm', 'Teqemt', 'Hedar', 'Tahesas', 'Ter', 'Yäkatit', 'Mägabit', 'Miyazya', 'Guenbot', 'Säné', 'Hamlé', 'Nähasé', 'Pagumén'],
  'field-year': 'år',
  'field-week-relative+0': 'denna vecka',
  'months-standAlone-abbr': ['Mäskäräm', 'Teqemt', 'Hedar', 'Tahesas', 'Ter', 'Yäkatit', 'Mägabit', 'Miyazya', 'Guenbot', 'Säné', 'Hamlé', 'Nähasé', 'Pagumén'],
  ...
  'field-month': 'månad',
  'months-format-wide': ['mäskäräm', 'teqemt', 'hedar', 'tahesas', 'ter', 'yäkatit', 'mägabit', 'miyazya', 'guenbot', 'säné', 'hamlé', 'nähasé', 'pagumén'],
  'field-era': 'era',
  'field-year-relative+0': 'i år',
  'field-year-relative+1': 'nästa år',
  'months-format-abbr': ['mäskäräm', 'teqemt', 'hedar', 'tahesas', 'ter', 'yäkatit', 'mägabit', 'miyazya', 'guenbot', 'säné', 'hamlé', 'nähasé', 'pagumén'],
