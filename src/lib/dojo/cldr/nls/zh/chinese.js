define(//begin v1.x content
{
  ...
  'field-weekday': '星期',
  'months-standAlone-narrow': ['正', '二', '三', '四', '五', '六', '七', '八', '九', '十', '十一', '十二'],
  'field-era': '时期',
  'dateFormatItem-Gy': 'U年',
  'field-hour': '小时',
  'dateFormatItem-y': 'U年',
  'dateFormatItem-yyyy': 'U年',
  'months-standAlone-abbr': ['正月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'],
  ...
  'months-standAlone-wide': ['正月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'],
  'field-week': '周',
  ...
  'months-format-abbr': ['正月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'],
  ...
  'months-format-narrow': ['正', '二', '三', '四', '五', '六', '七', '八', '九', '十', '十一', '十二'],
  'dateFormat-short': 'U-M-d',
  'dateFormatItem-yyyyM': 'U年M月',
  'dateFormat-full': 'U年MMMd日EEEE',
  'dateFormatItem-Md': 'M-d',
  'months-format-wide': ['正月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'],
