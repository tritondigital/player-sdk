define(//begin v1.x content
{
  ...
  'months-format-wide': ['Moharrem', 'Safar', 'Rébi el avvel', 'Rébi el accher', 'Dsemádi el avvel', 'Dsemádi el accher', 'Redseb', 'Sabán', 'Ramadán', 'Sevvál', 'Dsül kade', 'Dsül hedse'],
  ...
  'field-era': 'éra',
  'months-standAlone-wide': ['Moharrem', 'Safar', 'Rébi I', 'Rébi II', 'Dsemádi I', 'Dsemádi II', 'Redseb', 'Sabán', 'Ramadán', 'Sevvál', 'Dsül kade', 'Dsül hedse'],
  'timeFormat-short': 'H:mm',
  'quarters-format-wide': ['I. negyedév', 'II. negyedév', 'III. negyedév', 'IV. negyedév'],
  'timeFormat-long': 'H:mm:ss z',
  'field-year': 'év',
  'field-hour': 'óra',
  'months-format-abbr': ['Moh.', 'Saf.', 'Rébi I', 'Rébi II', 'Dsem. I', 'Dsem. II', 'Red.', 'Sab.', 'Ram.', 'Sev.', 'Dsül k.', 'Dsül h.'],
  ...
  'dateFormatItem-H': 'H',
  'months-standAlone-abbr': ['Moh.', 'Saf.', 'Rébi I', 'Rébi II', 'Dsem. I', 'Dsem. II', 'Red.', 'Sab.', 'Ram.', 'Sev.', 'Dsül k.', 'Dsül h.'],
