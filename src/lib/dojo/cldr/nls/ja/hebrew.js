define(//begin v1.x content
{
  ...
  'months-format-wide': ['ティスレ', 'へシボン', 'キスレブ', 'テベット', 'シバット', 'アダル I', 'アダル', 'ニサン', 'イヤル', 'シバン', 'タムズ', 'アヴ', 'エルル'],
  ...
  'field-era': '時代',
  'months-standAlone-wide': ['ティスレ', 'へシボン', 'キスレブ', 'テベット', 'シバット', 'アダル I', 'アダル', 'ニサン', 'イヤル', 'シバン', 'タムズ', 'アヴ', 'エルル'],
  ...
  'months-format-abbr': ['ティスレ', 'へシボン', 'キスレブ', 'テベット', 'シバット', 'アダル I', 'アダル', 'ニサン', 'イヤル', 'シバン', 'タムズ', 'アヴ', 'エルル'],
  ...
  'dateFormatItem-H': 'H時',
  'months-standAlone-abbr': ['ティスレ', 'へシボン', 'キスレブ', 'テベット', 'シバット', 'アダル I', 'アダル', 'ニサン', 'イヤル', 'シバン', 'タムズ', 'アヴ', 'エルル'],
