define(//begin v1.x content
{
  ...
  'months-standAlone-wide': ['トウト', 'ババ', 'ハトール', 'キアック', 'トーバ', 'アムシール', 'バラムハート', 'バラモウダ', 'バシャンス', 'パオーナ', 'エペープ', 'メスラ', 'ナシエ'],
  'field-year': '年',
  'field-week-relative+0': '今週',
  'months-standAlone-abbr': ['トウト', 'ババ', 'ハトール', 'キアック', 'トーバ', 'アムシール', 'バラムハート', 'バラモウダ', 'バシャンス', 'パオーナ', 'エペープ', 'メスラ', 'ナシエ'],
  ...
  'field-month': '月',
  'months-format-wide': ['トウト', 'ババ', 'ハトール', 'キアック', 'トーバ', 'アムシール', 'バラムハート', 'バラモウダ', 'バシャンス', 'パオーナ', 'エペープ', 'メスラ', 'ナシエ'],
  'field-era': '時代',
  'field-year-relative+0': '今年',
  'field-year-relative+1': '翌年',
  'months-format-abbr': ['トウト', 'ババ', 'ハトール', 'キアック', 'トーバ', 'アムシール', 'バラムハート', 'バラモウダ', 'バシャンス', 'パオーナ', 'エペープ', 'メスラ', 'ナシエ'],
  'field-weekday': '曜日',
  'field-zone': 'タイムゾーン'
});
//end v1.x content
