define(//begin v1.x content
{
  ...
  'months-standAlone-wide': ['カイトラ', 'ヴァイサカ', 'ジャイスタ', 'アーサダ', 'スラバナ', 'バードラ', 'アスビナ', 'カルディカ', 'アヴラハヤナ', 'パウサ', 'マーガ', 'パルグナ'],
  'field-year': '年',
  'field-week-relative+0': '今週',
  'months-standAlone-abbr': ['カイトラ', 'ヴァイサカ', 'ジャイスタ', 'アーサダ', 'スラバナ', 'バードラ', 'アスビナ', 'カルディカ', 'アヴラハヤナ', 'パウサ', 'マーガ', 'パルグナ'],
  ...
  'field-month': '月',
  'months-format-wide': ['カイトラ', 'ヴァイサカ', 'ジャイスタ', 'アーサダ', 'スラバナ', 'バードラ', 'アスビナ', 'カルディカ', 'アヴラハヤナ', 'パウサ', 'マーガ', 'パルグナ'],
  'field-era': '時代',
  'field-year-relative+0': '今年',
  'field-year-relative+1': '翌年',
  'months-format-abbr': ['カイトラ', 'ヴァイサカ', 'ジャイスタ', 'アーサダ', 'スラバナ', 'バードラ', 'アスビナ', 'カルディカ', 'アヴラハヤナ', 'パウサ', 'マーガ', 'パルグナ'],
  eraAbbr: ['サカ'],
  'field-weekday': '曜日',
  'field-zone': 'タイムゾーン'
});
