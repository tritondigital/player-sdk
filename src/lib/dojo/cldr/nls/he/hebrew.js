define(//begin v1.x content
{
  ...
  'months-format-narrow': ['תש', 'חש', 'כס', 'טב', 'שב', 'אא', 'אד', 'ני', 'אי', 'סי', 'תמ', 'אב', 'אל'],
  ...
  'months-format-wide': ['תשרי', 'חשוון', 'כסלו', 'טבת', 'שבט', 'אדר א׳', 'אדר', 'ניסן', 'אייר', 'סיון', 'תמוז', 'אב', 'אלול'],
  ...
  'field-era': 'תקופה',
  'months-standAlone-wide': ['תשרי', 'חשון', 'כסלו', 'טבת', 'שבט', 'אדר א׳', 'אדר', 'ניסן', 'אייר', 'סיון', 'תמוז', 'אב', 'אלול'],
  'quarters-format-wide': ['רבעון 1', 'רבעון 2', 'רבעון 3', 'רבעון 4'],
  'field-year': 'שנה',
  'dateFormatItem-yyyyMMMM': 'MMMM y',
  'field-hour': 'שעה',
  'months-format-abbr-leap': 'אדר ב׳',
  'months-format-abbr': ['תשרי', 'חשוון', 'כסלו', 'טבת', 'שבט', 'אדר א׳', 'אדר', 'ניסן', 'אייר', 'סיון', 'תמוז', 'אב', 'אלול'],
  'field-day-relative+0': 'היום',
  'field-day-relative+1': 'מחר',
  'dateFormatItem-GyMMMd': 'd MMMM y G',
  'field-day-relative+2': 'מחרתיים',
  'months-standAlone-abbr': ['תשרי', 'חשוון', 'כסלו', 'טבת', 'שבט', 'אדר א׳', 'אדר', 'ניסן', 'אייר', 'סיוון', 'תמוז', 'אב', 'אלול'],
  ...
  'months-standAlone-narrow': ['תש', 'חש', 'כס', 'טב', 'שב', 'אא', 'אד', 'ני', 'אי', 'סי', 'תמ', 'אב', 'אל'],
