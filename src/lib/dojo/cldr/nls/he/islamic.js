define(//begin v1.x content
{
  ...
  'months-format-wide': ['מוחרם', 'צפר', 'רביע אל-אוול', 'רביע א-ת׳אני', 'ג׳ומאדא אל-אולא', 'ג׳ומאדא א-ת׳אניה', 'רג׳ב', 'שעבאן', 'רמדאן', 'שוואל', 'ד׳ו אל-קעדה', 'ד׳ו אל-חיג׳ה'],
  ...
  'field-era': 'תקופה',
  'months-standAlone-wide': ['מוחרם', 'צפר', 'רביע אל-אוול', 'רביע א-ת׳אני', 'ג׳ומאדא אל-אולא', 'ג׳ומאדא א-ת׳אניה', 'רג׳ב', 'שעבאן', 'רמדאן', 'שוואל', 'ד׳ו אל-קעדה', 'ד׳ו אל-חיג׳ה'],
  'quarters-format-wide': ['רבעון 1', 'רבעון 2', 'רבעון 3', 'רבעון 4'],
  'field-year': 'שנה',
  'field-hour': 'שעה',
  'months-format-abbr': ['מוחרם', 'צפר', 'רביע א׳', 'רביע ב׳', 'ג׳ומאדא א׳', 'ג׳ומאדא ב׳', 'רג׳ב', 'שעבאן', 'רמדאן', 'שוואל', 'ד׳ו אל-קעדה', 'ד׳ו אל-חיג׳ה'],
  'field-day-relative+0': 'היום',
  'field-day-relative+1': 'מחר',
  'dateFormatItem-GyMMMd': 'd בMMM y G',
  'field-day-relative+2': 'מחרתיים',
  'months-standAlone-abbr': ['מוחרם', 'צפר', 'רביע א׳', 'רביע ב׳', 'ג׳ומאדא א׳', 'ג׳ומאדא ב׳', 'רג׳ב', 'שעבאן', 'רמדאן', 'שוואל', 'ד׳ו אל-קעדה', 'ד׳ו אל-חיג׳ה'],
